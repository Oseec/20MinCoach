...
const testimonials = [
  {
    ...
    rating: 5,
    comment:
      'Increíble poder consultar con expertos de forma tan rápida y efectiva',
  },
  {
    name: 'Carlos Rivera',
    role: 'Desarrollador',
    rating: 5,
    comment:
      'Los coaches de tecnología me han ayudado a resolver problemas complejos',
  },
];
            ...
            <div className="space-y-8 animate-fade-in">
              <div>
                ...
                <p className="text-xl md:text-2xl text-white/90 leading-relaxed">
                  Conecta instantáneamente con coaches expertos en salud,
                  psicología, tecnología, derecho y más. Resuelve tus dudas de
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Una nueva forma de acceder a coaching profesional, diseñada para
              tu estilo de vida
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-hero text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
            Únete a miles de usuarios que ya están aprovechando el poder del
